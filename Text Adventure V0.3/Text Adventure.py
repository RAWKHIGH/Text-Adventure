...
def toll_1():
	...
	while choice == '0':
		...
		print ('Too the East you hear the ramblings of 2 drunken kingsmen')
...
def toll_2():
	choice2 = '0'
		...
		print("the kingsman your looking for isn't here")
		time.sleep(2)
		print
		print ('Too the East you smell cooking food')
		print ('Too the West you hear what sounds like a blacksmith')
		print ('Would you like to go East or West? (e or w)')
		print
		path = raw_input()
...
def toll_3():
	...
	while choice3 == '0':
		...
		time.sleep(2)
		print
		print('and a rabit jumps out, startiling you')
		print("the kingsman your looking for isn't here")
		time.sleep(2)
		print
		print ('Too the East you see an outpost')
		print ('Too the West you see a seemingly safe path')
		print ('Would you like to go East or West? (e or w)')
		print
		path = raw_input()
...
def toll_4():
	...
	while choice4 == '0':
		...
		time.sleep(2)
		print
		print('you stumble apon an old outpost')
		print("the kingsman your looking for isn't here")
		time.sleep(2)
		print
		print ('Too the East you ')
		print ('Too the West you ')
		print ('Would you like to go East or West? (e or w)')
		print
		path = raw_input()
